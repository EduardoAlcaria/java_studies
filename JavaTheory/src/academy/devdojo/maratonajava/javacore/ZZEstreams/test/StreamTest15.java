...
public class StreamTest15 {
    ...
    private static Promotion getPromotion(LightNovel ln){
       return ln.getPrice () < 6 ? Promotion.UNDER_PROMOTION : Promotion.PROMOTION;
    }
}
